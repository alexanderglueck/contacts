...
<template>
    <AppLayout :title="`Call ${item.formatted_called_at} — ${contact.fullname}`">
        ...
        <div class="text-sm">
            <Link :href="route('contact_calls.index', contact.ulid)" class="text-indigo-600 hover:text-indigo-500">
                &larr; Back to calls
            </Link>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="flex gap-2 text-sm">
                    <Link
                        v-if="can.edit"
                        :href="route('contact_calls.edit', [contact.ulid, item.ulid])"
                    ...
                    <Link
                        v-if="can.delete"
                        :href="route('contact_calls.delete', [contact.ulid, item.ulid])"
