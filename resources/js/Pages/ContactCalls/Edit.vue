...
const submit = () => form.put(route('contact_calls.update', [props.contact.ulid, props.item.ulid]));
</script>

<template>
    <AppLayout :title="`${contact.fullname} — Edit call`">
        <Head :title="`${contact.fullname} — Edit call`" />
