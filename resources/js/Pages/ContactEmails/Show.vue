...
<template>
    <AppLayout :title="`${item.name} — ${contact.fullname}`">
        ...
        <div class="text-sm">
            <Link :href="route('contact_emails.index', contact.slug)" class="text-indigo-600 hover:text-indigo-500">
                &larr; Back to emails
            </Link>
        </div>
        ...
        <div class="bg-white shadow rounded-lg">
            <div class="px-6 py-4 border-b border-gray-200 flex justify-between items-center">
                ...
                <div class="flex gap-2 text-sm">
                    <Link
                        v-if="can.edit"
                        :href="route('contact_emails.edit', [contact.slug, item.slug])"
                    ...
                    <Link
                        v-if="can.delete"
                        :href="route('contact_emails.delete', [contact.slug, item.slug])"
