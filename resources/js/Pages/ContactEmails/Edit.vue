...
const submit = () => form.put(route('contact_emails.update', [props.contact.ulid, props.item.ulid]));
</script>

<template>
    <AppLayout :title="`${contact.fullname} — Edit email`">
        <Head :title="`${contact.fullname} — Edit email`" />
