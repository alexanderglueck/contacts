 ...
 * app's onMessageReceived run in every app state — including killed/background
 * — so it can render the notification itself (controlling grouping/stacking)
 * and deep-link taps to the calendar. A notification block would otherwise be
 * intercepted by the system tray and skip onMessageReceived. title/body ride
 * along in the data payload for the app to display.
 *
